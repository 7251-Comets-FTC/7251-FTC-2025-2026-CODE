        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.y == true) {
                ...
                if (gamepad2.left_trigger + gamepad2.right_trigger > 0) { // negative values extend pos values retract
                    ...
                    viperExt2 += gamepad2.left_trigger - gamepad2.right_trigger;
                    viperExt3 += gamepad2.right_trigger - gamepad2.left_trigger;
...
//            }
            ...
            robot.motor5.setPower(-1 * pitchArm * throttle_control* -slowDown3);
            robot.motor6.setPower(viperExt2 * slowDown2);
            robot.motor7.setPower(actuatorExt * slowDown2);
            robot.motor8.setPower(viperExt3 * slowDown2);
