...
//      This is what Actually Controls the Robot, Motors 1-4 are Mechanum Wheel Control and Motor 5 is Launching Wheel.
        while (opModeIsActive()) {
            ...
            robot.motor3.setPower(frontLeftPower * throttle_control * slowdown);
            robot.motor4.setPower(backLeftPower * throttle_control * slowdown);
            ...
            if (gamepad2.a) {
                robot.motor5.setPower(-0.4); //motor5=front intake
                robot.motor6.setPower(-0.4); //motor6=rear intake
            }
            else {
            ...
            if (gamepad2.b){
                robot.motor7.setPower(-0.85); //motor7=launch
            }
            else {
            ...
            if (gamepad2.x) {
                robot.servo1.setPosition(0.6); //servo1
